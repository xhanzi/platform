...
@section('content')
    ...
    <div class="layui-card">
        <div class="layui-form layui-card-header light-search">
            ...
            @include('admin.searchField', ['data' => App\Model\Admin\Template::$searchField])
        ...
        <div class="layui-card-body">
            <table class="layui-table" lay-data="{url:'{{ route('admin::template.list') }}?{{ request()->getQueryString() }}', page:true, limit:20, id:'test', toolbar:'<div><a href=\'{{ route('admin::template.create') }}\'><i class=\'layui-icon layui-icon-add-1\'></i>新增模板</a></div>'}" lay-filter="test">
                <thead>
                <tr>
