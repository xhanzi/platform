...
@section('content')
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <table class="layui-table" lay-data="{url:'{{ route('admin::role.list') }}?{{ request()->getQueryString() }}', page:true, limit:20, id:'test', toolbar:'<div><a href=\'{{ route('admin::role.create') }}\'><i class=\'layui-icon layui-icon-add-1\'></i>新增角色</a></div>'}" lay-filter="test">
                <thead>
                <tr>
