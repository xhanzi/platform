...
@section('content')
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <table class="layui-table" lay-data="{url:'{{ route('admin::entityField.list') }}?{{ request()->getQueryString() }}', page:true, limit:20, id:'test', toolbar:'<div><a href=\'{{ route('admin::entityField.create') }}?{{ request()->getQueryString() }}\'><i class=\'layui-icon layui-icon-add-1\'></i>新增模型字段</a> （单击排序值可直接编辑）</div>'}" lay-filter="test">
                <thead>
                <tr>
