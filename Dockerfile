...
RUN apk update && apk add --no-cache build-base shadow curl php7 php7-fpm php7-common php7-pdo php7-mcrypt php7-mbstring php7-xml php7-openssl \
...
RUN #usermod -u 1000 www-data && \
    composer install && composer update && composer upgrade && npm i
